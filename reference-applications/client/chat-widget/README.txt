...
This folder contains source code of a sample chat widget that can be embedded on a web page. The chat widget uses the Chat SDK to showcase chat capabilities.
...
Default Value: "md"
Description: an object to be passed to the CCaaS as an engagement parameters.
...
Description: the chat integration id with the CCaaS server to identify the tenant.
